...
export default function SimpleTemplate({ data, user }) {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white border border-gray-200 rounded-lg text-gray-900 font-sans">
